...
class EntryTagCreationDialog extends StatefulWidget {
  const EntryTagCreationDialog({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _EntryTagCreationDialog();
}
