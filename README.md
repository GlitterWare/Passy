...
If you are building for Linux, you will need to install one extra package required to build Passy's GUI and video features: `libayatana-appindicator3-dev meson nasm`.  
On Ubuntu/Debian Linux, you can install it using apt:
```bash
sudo apt install -y libayatana-appindicator3-dev meson nasm
```
